      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <section aria-labelledby="kontakt">
            <h3 id="kontakt" className="text-lg font-semibold mb-4 text-foreground">Kontakt</h3>
            
            {/* Logo en su propia fila */}
            <div className="footer-brand-row">
              <img 
                src="/brand/logo-48.svg" 
                alt="Tech Hilfe Pro" 
                width="32" 
                height="32"
                loading="lazy"
                decoding="async"
              />
              <span className="brand-footer">Tech <span className="brand-orange">Hilfe</span> Pro</span>
            </div>

            {/* Contacto con iconos alineados */}
            <ul className="footer-contact">
              <li className="footer-line">
                <MapPin className="i i-location" aria-hidden="true" />
                <div>
                  <p>Büro in Köln (HO).</p>
              ...
              <li className="footer-line">
                <Phone className="i i-phone" aria-hidden="true" />
                <a 
              ...
              <li className="footer-line">
                <Mail className="i i-mail" aria-hidden="true" />
                <a 
              ...
              <li className="footer-line">
                <Clock className="i i-clock" aria-hidden="true" />
                <div>
