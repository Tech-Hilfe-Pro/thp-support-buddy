      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="kontakt-icons space-y-3 text-sm text-muted-foreground">
              <li>
                <div className="flex items-start gap-2">
                  <MapPin className="w-6 h-6 mt-0.5 flex-shrink-0" aria-hidden="true" />
                  <div>
              ...
              <li>
                <a 
                  ...
                  aria-label={`Anrufen: ${COMPANY.telDisplay}`}
                >
                  <Phone aria-hidden="true" />
                  <span className="label">{COMPANY.telDisplay}</span>
                </a>
              </li>
              <li>
                <a 
                  href={`mailto:${COMPANY.email}`}
                  aria-label={`E-Mail schreiben: ${COMPANY.email}`}
                >
              ...
              <li className="footer-accent mt-4">
                <a
                ...
                >
                  ...
                  <span className="label">{CONTACT.WHATSAPP_LABEL}</span>
                </a>
              </li>
            </ul>
          </div>
