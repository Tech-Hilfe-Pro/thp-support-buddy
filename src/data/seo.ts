...
export const SEO_PAGES: Record<string, SeoEntry> = {
  ...
  kasseErfolg: { title: "Zahlung erfolgreich | IT-Service Köln", description: "Vielen Dank! Ihre Zahlung war erfolgreich. Wir bestätigen Ihr Abo per E-Mail.", path: "/kasse/erfolg" },
  kasseAbbruch: { title: "Zahlung abgebrochen | IT-Service Köln", description: "Zahlung wurde abgebrochen. Sie können jederzeit einen neuen Versuch starten.", path: "/kasse/abbruch" },
  kasseFehler: { title: "Zahlungsfehler | IT-Service Köln", description: "Bei der Zahlung ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut oder kontaktieren Sie uns.", path: "/kasse/fehler" },
  ...
  abo: { title: "Abo-Verwaltung | IT-Service Köln", description: "Verwalten Sie Ihr IT-Service Abo. Rechnungen einsehen, Plan ändern oder kündigen.", path: "/abo" },
